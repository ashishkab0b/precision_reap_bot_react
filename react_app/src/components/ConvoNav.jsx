...
import { Box, List, ListItemButton, ListItemText, Divider, Button, IconButton, Tooltip } from '@mui/material';
import DeleteIcon from '@mui/icons-material/Delete';
import api from '../api/axios';

const ConvoNav = ({ onConvoSelect }) => {
  const [convos, setConvos] = useState([]);
  
  // Fetch existing convos
  useEffect(() => {
